...
sleep_min = [["Email","TotalMinutesAsleep1","TotalMinutesAsleep2","TotalMinutesAsleep3","TotalMinutesAsleep4","TotalMinutesAsleep5","TotalMinutesAsleep6","TotalMinutesAsleep7"],
    ...
    ["Adam.Callie@stud.cs.pub.ro","420","291","447","428","441","486","439"],
    ...
    ["Adeline.Theo@stud.cs.pub.ro","442","106","250","293","398","404","471"],
    ...
    ["Adrian.Eleanor@stud.cs.pub.ro","411","543","421","277","384","74","342"],
    ["Noah.Olivia@stud.cs.pub.ro","379","392","552","436","339","331","631"],
    ["Aurora.Luke@stud.cs.pub.ro","337","492","465","421","465","450","293"],
    ["Ariana.Colton@stud.cs.pub.ro","520","503","492","469","286","329","622"],
    ...
    ["Brooklyn.Ian@stud.cs.pub.ro","126","59","480","428","433","436","486"],
    ...
    ["Camilla.Carter@stud.cs.pub.ro","459","442","750","369","477","368","436"],
    ...
    ["Carson.Hannah@stud.cs.pub.ro","377","722","333","421","388","429","237"],
    ...
    ["Claire.Evan@stud.cs.pub.ro","527","357","545","485","59","332","549"],
